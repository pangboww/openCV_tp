...
#include <opencv/cv.h>	// For Mat and Scalar
using namespace cv;
...
class CvHistograms : virtual public CvProcessor
{
	...
	public:
		 ...
		 */
		virtual void updateHistogram(void);
...
//		 */
//		const Mat & getHistogramImage(void) const;
//
//		/**
//		 * Gets Histogram display frame pointer
//		 * @return the image histogram is drawn in
//		 */
//		Mat * getHistogramImagePtr(void);
...
//		 */
//		const Mat & getTransfertFuncImage(void) const;
//
//		/**
//		 * Gets Transfert Func display frame pointer
//		 * @return the image transfert func is drawn in
//		 */
//		Mat * getTransfertFuncImagePtr(void);
...
//		/**
//		 * Histograms values accessor
//		 * @return the histograms values
//		 * @see #histograms
//		 */
//		const vector<float *> & getHistogramValues() const;

//		/**
//		 * Cumulative histograms values accessor
//		 * @return the cumulative histograms values
//		 * @see #cumulHistograms
//		 */
//		const vector<float *> & getCumulativeHistogramValues() const;

//		/**
//		 * Mono Channel (gray) transfert function accessor
//		 * @return reference to the monoTransfertFunc
//		 * @see #monoTransfertFunc
//		 */
//		const Mat & getMonoTransfertFunc() const;

//		/**
//		 * Color (3 channels) transfert function accessor
//		 * @return reference to the color transfert function
//		 * @see #colorTransfertFunc
//		 */
//		const Mat & getColorTransfertFunc() const;
		 ...
		 */
		virtual void setTimeCumulative(bool value);
		 ...
		 */
		virtual void setCumulative(bool value);
		 ...
		 */
		virtual void setLUTParam(float currentParam);

//		/**
//		 * Gets the transformed image after drawTransformedImage
//		 * @return the out display frame
//		 */
...
//		Mat * getTransformedImagePtr();
	...
	protected:
		 ...
		 */
		virtual void drawHistograms(void);
		 ...
		 * would contain the exact same values.
		 */
		Mat * computeLinearColorLUT(void);
		 ...
		 * @post the result is stored in monoTransfertFunc
		 */
		Mat * computeGrayOptimalLUT(unsigned int percentDynamic);
		 ...
		 * @post the result is stored in colorTransfertFunc
		 */
		Mat * computeColorOptimalLUT(unsigned int percentDynamic);
		 ...
		 * @post the result is stored in monoTransfertFunc
		 */
		Mat * computeGrayEqualizeLUT(void);
		 ...
		 */
		Mat * computeColorEqualizeLUT(void);
		 ...
		 * @post the result is stored in monoTransfertFunc
		 */
		Mat * computeGrayThresholdLUT(float tPercent);
		 ...
		 * @post the result is stored in colorTransferFunc
		 */
		Mat * computeColorThresholdLUT(float tPercent);
		 ...
		 * lutType is NONE
		 */
		virtual bool drawTransformedImage(void);
};
