...
class QcvHistograms: public QcvProcessor, public CvHistograms8UC3
{
	...
	public:
		 ...
		 */
		void setTimeCumulative(bool value);
		 ...
		 */
		void setShowComponent(size_t i,
							   bool value);
		/**
...
//		/**
//		 * Sets the current LUT % parameter with notification
//		 * @param lutParam the new LUT parameter
//		 */
//		void setLUTParam(float currentParam);
	...
	protected:
		 ...
		 * lutType is NONE
		 */
		bool drawTransformedImage(void);
